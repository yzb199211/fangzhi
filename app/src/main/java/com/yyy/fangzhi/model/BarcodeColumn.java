...
public class BarcodeColumn {
     ...
     * iColumnNum : 1
     * iDetail : 1
     * sFieldsName : sBarCode
     * sFieldsDisplayName : 条码
     * sFieldsType : string
     * iDigit : 0
     * sDefaultValue :
     * iRequired : 0
    ...
    public int getISummaryDigit() {
        return iSummaryDigit;
    }

    public void setISummaryDigit(int iSummaryDigit) {
        this.iSummaryDigit = iSummaryDigit;
    }
}
