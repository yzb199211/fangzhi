...
public class DeleteDialog extends Dialog implements View.OnClickListener {
     ...
     * @return
     */
    public DeleteDialog title(String title) {
        this.title = title;
        return this;
    }
     ...
     * @return
     */
    public DeleteDialog content(String content) {
        this.content = content;
        return this;
    }
     ...
     * @return
     */
    public DeleteDialog setPositiveName(String positiveName) {
     ...
     * @return
     */
    public DeleteDialog setNegativeName(String negativeName) {
